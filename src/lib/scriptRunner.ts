...
export async function runScript(
  ...
  const con = {
    log:   (...a: unknown[]) => { logs.push({ level: 'log',   msg: fmt(a) }); onUpdate([...calls], [...logs]); },
    error: (...a: unknown[]) => { logs.push({ level: 'error', msg: fmt(a) }); onUpdate([...calls], [...logs]); },
    warn:  (...a: unknown[]) => { logs.push({ level: 'warn',  msg: fmt(a) }); onUpdate([...calls], [...logs]); },
    info:  (...a: unknown[]) => { logs.push({ level: 'info',  msg: fmt(a) }); onUpdate([...calls], [...logs]); },
  };
