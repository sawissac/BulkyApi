...
## Corpus Check
- 104 files · ~78,423 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 998 nodes · 1664 edges · 128 communities (62 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bec1b575`
...
Cohesion: 0.06
Nodes (33): Props, EditorInstance, IGNORED_DIAGNOSTICS, Props, PayloadTab(), Props, makeExpect(), Matchers (+25 more)
...
Cohesion: 0.08
Nodes (38): BulkyApp(), LAYOUT_SIZES, highlightLog(), LEVEL_CHIP, LOG_PALETTE, LOG_TONE, LogColors, LogLine() (+30 more)
...
Cohesion: 0.14
Nodes (20): isSseBody(), KIND_LABEL, NonJsonBody(), ParsedSseEvent, parseSseBody(), Props, RespTab(), ViewMode (+12 more)
...
Cohesion: 0.1
Nodes (15): DisplayModeDialogProps, OPTIONS, PANE_LABELS, SidebarProps, DisplayMode, initialState, ResponseView, selectDisplayMode() (+7 more)
...
Cohesion: 0.14
Nodes (23): CollPane, ConfirmDialog, CurlImportDialog, EnvPane, ExampleDialog, FilePane, downloadBlob, pickFile (+15 more)
...
Cohesion: 0.17
Nodes (12): Props, CallCard(), Props, Props, Props, StatusTab(), METHOD_CLR, METHOD_CLR_LIGHT (+4 more)

### Community 14 - "BulkyApp Debounce & Improvements"
Cohesion: 0.15
Nodes (12): ActivityRail(), TABS, useDisplayMode(), authSlice, AuthState, AuthStatus, initialState, selectAuthStatus() (+4 more)
...
Cohesion: 0.13
Nodes (10): Props, LAYOUT_OPTIONS, THEME_CORNER_CLASS, THEME_OPTIONS, TweaksPanelProps, THEMES, LayoutKey, selectCallTimeout() (+2 more)

### Community 19 - "Redux Reducers & Mock Store"
Cohesion: 0.19
Nodes (10): Props, TONES, ImportCollectionDialogProps, curlToScript(), parseCurl(), ParsedCurl, tokenize(), downloadBlob() (+2 more)
...
Cohesion: 0.15
Nodes (15): ActivityRail, Button, ButtonGroup, DisplayModeDialog, Keyboard shortcut for Run, MocksComponentsPage, MonacoCodeEditor, ServiceWorkerRegister (+7 more)

### Community 25 - "Brand Marks"
Cohesion: 0.18
Nodes (8): metadata, viewport, applySnapshot(), clearEditorWithoutCollections(), LegacyEnvState, ServiceWorkerRegister(), useServiceWorker(), PersistedShape
...
Cohesion: 0.18
Nodes (9): Props, MocksComponentsPage(), Props, StatusScreen(), StatusTone, TONE, methodVars(), ThemeKey (+1 more)
...
Cohesion: 0.31
Nodes (8): getSupabaseBrowser(), CollectionItemRow, CollectionRow, EnvironmentRow, RunnerSnapshot, SyncSnapshot, UserStateRow, pullRemoteState()
...
Cohesion: 0.2
Nodes (6): EditCell, Props, SENSITIVE, VarSectionProps, selectActiveEnv(), selectBaseVars()

### Community 37 - "PostCSS Config Note"
Cohesion: 0.2
Nodes (4): CollectionHooksDialogProps, Props, ConfirmDialogProps, selectCollections()
...
- **What is the exact relationship between `Bulky API Logo Mark` and `BulkyApi Favicon Icon`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `MocksComponentsPage` connect `removeItem Cross-Slice Cleanup` to `App Bootstrap & Providers`, `ESLint Config Note`, `Redux Store Architecture`, `SSE Response Parsing`, `File Import & Curl Parsing`, `Call Options Type`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `Theme` connect `Persistence & Improvement Notes` to `Layout & Display Modes`, `Error Boundary & Mock Fixtures`, `Sidebar Dialogs & Panes`, `PostCSS Config Note`, `Next.js Type Reference`, `Response Panel Tab Set`, `Code Editor State Wiring`, `Code Editor & Method Detail`, `Project Docs & Dependencies`, `Activity Rail & Display Mode Hooks`, `Redux Reducers & Mock Store`, `Service Worker Shell Cache`, `Icon Button Recipe`, `PostCSS Config`, `Next.js Config`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `BulkyApp` connect `File Import & Curl Parsing` to `removeItem Cross-Slice Cleanup`, `Script Runner Hook`, `SSE Response Parsing`, `Redux Store Architecture`?**
